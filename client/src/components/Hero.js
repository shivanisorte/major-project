  ...
  return (
    <Center bg="black" minH={"90vh"} flex>
      <VStack color="white" textAlign="center" spacing="10">
        ...
        <Text color="whiteAlpha.600" fontSize={["l", "l", "3xl", "3xl"]}>
          The only project management application in the world that tracks
          progress through GitHub commits.
        </Text>
